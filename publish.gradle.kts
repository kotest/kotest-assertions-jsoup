...
publishing {
  ...
  publications {
    register("mavenJava", MavenPublication::class) {
      ...
      pom {
        name.set("kotest-assertions-jsoup")
        description.set("Kotest assertions for jsoup")
        url.set("http://www.github.com/kotest/kotest-assertions-jsoup")

        scm {
          connection.set("scm:git:http://www.github.com/kotest/kotest-assertions-jsoup")
